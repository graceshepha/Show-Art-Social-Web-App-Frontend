        ...
        <div className="dropdown dropdown-end">
            ...
            <ul tabIndex={0} className="p-2 shadow menu dropdown-content bg-neutral rounded w-52">
                <div className="py-3 px-4">
                    <span className="block text-lg text-white font-bold dark:text-white">{user?.nickname}</span>
                    <span className="block text-base font-medium text-white truncate dark:text-gray-400">{user?.email}</span>
                </div>
